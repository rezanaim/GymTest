...
namespace GymTest.Persistence.Migrations
{
    ...
    [Migration("20251222083245_Wallet n Transaction")]
    partial class WalletnTransaction
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GymTest.Domain.Entities.WalletNmore.Transaction", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("GymTest.Domain.Entities.WalletNmore.Wallet", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("GymTest.Domain.Entities.WalletNmore.Transaction", b =>
                {
                    b.HasOne("GymTest.Domain.Entities.WalletNmore.Wallet", "Wallet")
            ...
            modelBuilder.Entity("GymTest.Domain.Entities.WalletNmore.Wallet", b =>
                {
                    b.HasOne("GymTest.Domain.Entities.Users.User", "User")
                        .WithOne("Wallet")
                        .HasForeignKey("GymTest.Domain.Entities.WalletNmore.Wallet", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
